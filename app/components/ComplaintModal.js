...
const ComplaintModal = (props) => {
  ...
  return (
    <div className="w-[35vw] h-[60vh] bg-white flex flex-col items-center justify-start gap-20 border-2 rounded-md">
      <div className="w-[35vw] h-[20vh] object-cover">
        <button
          className="w-[9vw] h-[6vh] bg-[#D89314] text-white flex items-center justify-center rounded-lg m-3 z-20"
          type="submit"
        >
          {category}
        </button>
