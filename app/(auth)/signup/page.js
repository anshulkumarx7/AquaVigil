            ...
            <div className="mt-16">
              ...
              >
                ...
                <div className="flex justify-center items-center gap-4">
                  <div className="">
                    ...
                    <input
                      ...
                      className="w-[10vw] h-[1vh] border-[#3B2C4DE] border-2 p-4 mb-2 focus:border-[#234DF0]"
                    ></input>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-[16vw] h-[1vh]  border-[#3B2C4DE] border-2 p-4 mb-2  focus:border-[#234DF0] relative"
                    ></input>
                ...
                <div className="flex items-center justify-start gap-2">
                  ...
                  <p className="text-[#3A4264]">
                    Agree to{" "}
                    <span className="text-[#234DF0]">Terms and Conditions</span>
                  </p>
                </div>

                <button
                  className="w-[27vw] h-[6vh] bg-[#234DF0] p-5 text-white flex items-center justify-center rounded-lg mt-3"
                  type="submit"
                >
                  Sign Up
                </button>
